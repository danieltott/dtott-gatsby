...
You can view the solution at work [here](http://dtott.com/examples/croppingcorners/index.html 'Cropping Corners Example') , and I'll try to take you through how it works.
