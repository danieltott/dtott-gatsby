...
<p>
  ...
  I was talking to <a href="http://www.wileymedia.com/">Eric Wiley</a> about the
  redesign I did for the <a href="http://www.freetimes.com">Free Times</a>, and <a href="http://meyerweb.com">
    Eric Meyer
  </a>, who came for the first time, overheard. He says "new site, huh?" and pulls
  out his laptop.
</p>
...
<p>
  ...
  , then use the javascript <code class="prettyprint">
    <a href="http://www.w3schools.com/jsref/jsref_unescape.asp">unescape()</a>
  </code> function when inserting the text. It seems silly, but works fine. I needed
  to use <code class="prettyprint">rawurlencode()</code> and not <code class="prettyprint">
    urlencode()
  </code> because <code>urlencode()</code> encodes spaces as '+' and javascript doesn't
  unescape them.
</p>
