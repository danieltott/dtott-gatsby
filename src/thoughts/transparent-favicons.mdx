...
export const summary = (
  <>
  <p>So I discovered the other day that it is possible to make transparent <a href="http&#58;//en.wikipedia.org/wiki/Favicon">favicons</a>.  Favicons are a good idea.  Transparent favicons are just awesome.</p>
  </>
)
...
<div class="post_image_container"><p><img src="/images/favicon_old.jpg" alt="Old Favicon" /></p></div>
...
<div class="post_image_container"><p><img src="/images/favicon_new.jpg" alt="New Favicon" /></p></div>
