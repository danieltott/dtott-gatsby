...
<h3>But...Why?</h3>
<p>
	Well, there's a few reasons.  First, by resetting the CSS, you remove the temptation to rely on browser defaults that may or may not be the same cross-browser.  <code>H1</code>s, at least to the naked eye, are pretty consistent across the field.  What about <code>fieldsets</code> or <code>dl</code>s?
</p>
<p>
